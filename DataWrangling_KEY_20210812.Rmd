---
title: "DataWrangling_SummerWorkshop"
author: "sbsambado"
date: "8/11/2021"
output: 
  html_document:
...
survey %>%
  ...
  ggplot(aes(x = speedKmHR, y = GPA, color = dareDevil)) + # plot these new variable values
...
CPS85 %>% 
  ...
  summarise(n = n(), # you are creating 6 columns of summary data for sector and sex
            min = fivenum(wage)[1], 
            Q1 = fivenum(wage)[2],
            median = fivenum(wage)[3],
            Q3 = fivenum(wage)[4],
